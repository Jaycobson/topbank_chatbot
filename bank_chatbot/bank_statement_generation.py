...
def generate_bank_transaction_data(num_transactions):
    data = []
    # Generate data starting from 200 days ago until today's date
    ...
    for i in range((end_date - start_date).days + 1):
        ...
        transaction_date = end_date - datetime.timedelta(days=200-i)
...
num_transactions = 200  # Number of transactions to generate
